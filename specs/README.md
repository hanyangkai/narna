...
| **Compatibility** | [`compatibility/SPEC.md`](compatibility/SPEC.md) | Badge program (UAP Compatible · Certified · Enterprise) |
| **Governance** | [`governance/SPEC.md`](governance/SPEC.md) | Fleet governance (`fleet.yaml`) |
